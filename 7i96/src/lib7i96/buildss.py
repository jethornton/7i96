...
def build(parent):
	...
	if parent.ssCardCB.currentText() == '7i64':
		...
		for i in range(48):
			if getattr(parent, 'ss7i70in_' + str(i)).text():
		...
		for i in range(48):
			if getattr(parent, 'ss7i71out_' + str(i)).text():
		...
		for i in range(48):
			if getattr(parent, 'ss7i72out_' + str(i)).text():
		...
		for i in range(32):
			if getattr(parent, 'ss7i87in_' + str(i)).text():
